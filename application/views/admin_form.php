								...
								<div class="Polaris-Banner Polaris-Banner--statusInfo Polaris-Banner--withinContentContainer" tabindex="0" role="status" aria-live="polite" aria-labelledby="Banner8Heading" aria-describedby="Banner8Content">
									...
									<div>
										...
										<div class="Polaris-Banner__Content" id="Banner8Content">
											...
											$charge_api_call = base_url() . "charge?" . $_SERVER['QUERY_STRING'] . "&code_access=" . $access_token;
											?>
											<!--<p class="main-activate-link"><a href="<?php //echo $charge_api_call . "&price=" . $app_total_charge.'&plantype=basic'; ?>" target="_blank" rel="noopener noreferrer">Activate</a></p>-->
											<p>
				...
				<div class="form-body">
							<div class="form-group">
								<div class="col-md-12">
									...
									<option value="none" <?php if($protocol == 'none'){ echo 'selected'; } ?>>None</option>
									<option value="ssl" <?php if($protocol == 'ssl'){ echo 'selected'; } ?>>SSL</option>
									<option value="tls" <?php if($protocol == 'tls'){ echo 'selected'; } ?>>TLS</option>
									</select>
...
<script>
	...
	var app = createApp({
		apiKey: 'df75bd99a61659fb1c7854581732af84',
